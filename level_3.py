def run_level_3(screen, hint_manager, preserve_state=False):
    ...
    if not hasattr(run_level_3, 'base_start_time'):
        ...
        run_level_3.paused_time = 0
        run_level_3.timer_paused = False
        run_level_3.pause_start = 0

    if preserve_state and run_level_3.base_start_time is not None:
        start_timer = run_level_3.base_start_time
        paused_time = run_level_3.paused_time
        timer_paused = run_level_3.timer_paused
        pause_start = run_level_3.pause_start
    else:
    ...
    while not level_complete:
        ...
        while run:
            ...
            if settings_open and not timer_paused:
                ...
                run_level_3.timer_paused = True
                run_level_3.pause_start = timer_pause_start
            elif not settings_open and timer_paused:
                timer_paused = False
                paused_time += pygame.time.get_ticks() - timer_pause_start
                run_level_3.paused_time = paused_time
                run_level_3.timer_paused = False
                ...
                if event.type == pygame.QUIT:
                    ...
                    if settings_open:
                        if close_button.is_clicked(click_pos):
                            ...
                            print("music is on")
                            continue
                        # if settings is open, don't process any other clicks
                        continue
            ...
            # Hint and Refresh buttons (always on top)
